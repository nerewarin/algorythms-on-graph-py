...
def check_snake_case_compliance(filenames: List[str]) -> Tuple[bool, List[Tuple[str, str]]]:
    """
...
def git_rename(old_path: Path, new_path: Path) -> bool:
...
def format_python_files(
    root_dir: str, dry_run: bool = False, verbose: bool = False, staged_only: bool = False
